...
export default function Edit({ courses,users ,batch}) {
    
    const { data, setData, post, processing, errors, reset } = useForm({
        teacher_id: batch.teacher_id,
        name:batch.name,
        nick_name: batch.nick_name,
        course_id: batch.course_id,
        start_date: batch.start_date,
        end_date: batch.end_date,
        start_time: batch.start_time,
        end_time: batch.end_time,
        number_of_days: batch.number_of_days,
        week_days: batch.week_days ? JSON.parse(batch.week_days) : [], // parse JSON array
    ...
    return (
        ...
        >
            <Head title="Batch" />
            <>
                <AddItemBreadCrums routeName="Batch.create" name="Edit Batch" details="Edit Batch for setting " />
                <div className="row">
