...
export default function List({ certificates }) {
  ...
  { label: "branch_id", key: "branch_id" },
    ...
    return (
        ...
        >
            ...
            <>
                <BreadCrums routeName="certificate.index" name="Certificate"  />
                
                <TableCardCertificate title="Certificate" headers={headers} data={certificates} />
            </>
