...
<head>
    <meta charset="UTF-8">
    <title>zzWelcome to {{ $company['company_name'] }}</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <p>We’re excited to have you onboard. Below are your login details for our e-learning platform:</p>

            <div class="details-box">
                <ul>
                    <li><strong>Portal:</strong> <a href="{{ $company['elearning_url'] }}">E-Learning Login</a></li>
            ...
            <p style="text-align:center;">
                <a href="{{ $company['elearning_url'] }}" class="btn">Access E-Learning</a>
            </p>
